...
namespace Polyphemalus.Content.Items
{
	...
	public class FusedEye : ModItem
	{
		public override void SetStaticDefaults() {
			...
			Tooltip.SetDefault("Summons Polyphemalus. Enrages during the day.");
		...
		public override bool CanUseItem(Player player) {
			...
			return !NPC.AnyNPCs(ModContent.NPCType<Content.NPCs.polyphemalus>());
		}
		...
		public override bool? UseItem(Player player) {
			if (player.whoAmI == Main.myPlayer) {
				...
				int type = ModContent.NPCType<Content.NPCs.polyphemalus>();
